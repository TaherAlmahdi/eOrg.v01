    ...
    >
      <div className="relative z-20 w-full max-w-none mx-auto">
        ...
        <div className="flex justify-center">
          <div className="inline-flex items-center justify-center gap-3 px-2 py-2 rounded bg-teal-50/90 text-[#008080] mb-8 border border-teal-100 shadow-xs text-center backdrop-blur-md">
          ...
          <div className="flex flex-wrap md:gap-3 justify-start items-stretch relative z-20 w-full">
            {authors.map(({ slug, name, count }) => (
              <Link
                ...
                className="flex items-center justify-between gap-3 px-2 py-3 rounded mb-1 bg-white/90 text-[#008080] border border-teal-100 shadow-sm transition-all duration-300 backdrop-blur-sm hover:bg-teal-50 hover:shadow-lg hover:border-teal-300 hover:scale-[1.02] shrink-0 grow basis-full sm:basis-[calc(50%-0.5rem)] lg:basis-[calc(33.333%-0.75rem)] xl:basis-[calc(25%-0.75rem)] 2xl:basis-[calc(20%-0.75rem)] max-w-full group cursor-pointer overflow-hidden"
              >
